...
<body>
    ...
    <form action="index.php" method="post">
        ...
        <?php endif; ?>
        <h3>Questions</h3>
        <p class="question">1. Quel serait le meilleur choix de mot de passe ?
        </p>
        ...
        <p class="question">2. Mr. Mouquet est parti en vacances. Afin que ses collègues puissent accéder aux dossiers nécessaires pendant son absence, que doit-il faire ?</p>
        ...
        <p class="question">4. Quel site est le plus sécurisé ?</p>
        ...
        <p class="question">6. Comment puis-je me rappeler de tous mes mots de passe ?</p>
        ...
        <p class="question">7. Que signifie l’authentification à deux facteurs ?</p>
        ...
        <p class="question">8. Je pense que mon mot de passe a été compromis, que dois-je faire ?</p>
        ...
        <p class="question">9. J’ai trouvé une clé USB dans le parking de mon entreprise. Que dois-je faire ?</p>
        ...
        <?php endif; ?>
        <input type="radio" class="" name="q10" value="a" <?= $this->input['q10'] == 'a' ? 'checked' : '' ?>>Pour changer l’apparence du système.<br>
