...
<body>
    ...
    <form action="index.php" method="post">
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q1'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q1" value="a" <?= $this->input['q1'][0] == 'a' ? 'checked' : '' ?>>
            jmmouquet<br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q1'][0] == 'b' ? 'incorrect' : '' ?>">
            <input type="radio" name="q1" value="b" <?= $this->input['q1'][0] == 'b' ? 'checked' : '' ?>>02101987<br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q1'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q1" value="c" <?= $this->input['q1'][0] == 'c' ? 'checked' : '' ?>>JmMouquet<br>
        </label>

        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q1" value="d" <?= $this->input['q1'][0] == 'd' ? 'checked' : '' ?>>Jm-02#M0uqu3T<br>
        </label>
        ...
        <?php endif; ?>
        <label class="<?= $this->questionnaireFinished && $this->input['q2'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q2" value="a" <?= $this->input['q2'][0] == 'a' ? 'checked' : '' ?>>Écrire son mot de passe sur un post-it et le laisser sur son bureau.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q2" value="b" <?= $this->input['q2'][0] == 'b' ? 'checked' : '' ?>>Envoyer ses dossiers par mail au chef de projet.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q2'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q2" value="c" <?= $this->input['q2'][0] == 'c' ? 'checked' : '' ?>>Donner son mot de passe à un collègue de confiance.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q2'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q2" value="d" <?= $this->input['q2'][0] == 'd' ? 'checked' : '' ?>>Ne pas verrouiller son poste de travail.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q3'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q3" value="a" <?= $this->input['q3'][0] == 'a' ? 'checked' : '' ?>>Celui de son compte bancaire.<br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q3'][0] == 'b' ? 'incorrect' : '' ?>">
            <input type="radio" name="q3" value="b" <?= $this->input['q3'][0] == 'b' ? 'checked' : '' ?>>Celui de son compte Netflix.<br>
        </label>

        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q3" value="c" <?= $this->input['q3'][0] == 'c' ? 'checked' : '' ?>>Celui de son compte de messagerie.<br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q3'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q3" value="d" <?= $this->input['q3'][0] == 'd' ? 'checked' : '' ?>>Celui de mon compte copain d’avant.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q4'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q4" value="a" <?= $this->input['q4'][0] == 'a' ? 'checked' : '' ?>><code>http://netfliix.com</code><br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q4'][0] == 'b' ? 'incorrect' : '' ?>">
            <input type="radio" name="q4" value="b" <?= $this->input['q4'][0] == 'b' ? 'checked' : '' ?>><code>http://net-flix.fr</code><br>
        </label>

        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q4" value="c" <?= $this->input['q4'][0] == 'c' ? 'checked' : '' ?>><code>https://netflix.com</code><br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q4'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q4" value="d" <?= $this->input['q4'][0] == 'd' ? 'checked' : '' ?>><code>https://netflx.com</code><br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q5'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q5" value="a" <?= $this->input['q5'][0] == 'a' ? 'checked' : '' ?>>Je clique tout de suite sur le bouton car c’est mon acteur favori.<br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q5'][0] == 'b' ? 'incorrect' : '' ?>">
            <input type="radio" name="q5" value="b" <?= $this->input['q5'][0] == 'b' ? 'checked' : '' ?>>Je réponds au mail pour demander des informations complémentaire <i>(et peut-être un petit autographe)</i><br>
        </label>

        <label class="<?= $this->questionnaireFinished && $this->input['q5'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q5" value="c" <?= $this->input['q5'][0] == 'c' ? 'checked' : '' ?>>Je le transfère à tous mes collègues.<br>
        </label>

        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q5" value="d" <?= $this->input['q5'][0] == 'd' ? 'checked' : '' ?>>Je supprime ou signale le mail comme phishing.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q6'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q6" value="a" <?= $this->input['q6'][0] == 'a' ? 'checked' : '' ?>>En utilisant toujours le même, c’est plus simple.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q6" value="b" <?= $this->input['q6'][0] == 'b' ? 'checked' : '' ?>>Utiliser un gestionnaire de mot de passe.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q6'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q6" value="c" <?= $this->input['q6'][0] == 'c' ? 'checked' : '' ?>>Ecrire tous mes mots de passe sur un papier.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q6'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q6" value="d" <?= $this->input['q6'][0] == 'd' ? 'checked' : '' ?>>Utiliser mon nom ainsi que mon année de naissance.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q7'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q7" value="a" <?= $this->input['q7'][0] == 'a' ? 'checked' : '' ?>>Utiliser deux mots de passe différents.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q7" value="b" <?= $this->input['q7'][0] == 'b' ? 'checked' : '' ?>>Se connecter avec un mot de passe et un second code de vérification.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q7'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q7" value="c" <?= $this->input['q7'][0] == 'c' ? 'checked' : '' ?>>Avoir deux comptes différents.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q7'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q7" value="d" <?= $this->input['q7'][0] == 'd' ? 'checked' : '' ?>>Changer son mot de passe deux fois par an.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q8'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q8" value="a" <?= $this->input['q8'][0] == 'a' ? 'checked' : '' ?>>Ne rien faire.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q8" value="b" <?= $this->input['q8'][0] == 'b' ? 'checked' : '' ?>>Changer immédiatement son mot de passe.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q8'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q8" value="c" <?= $this->input['q8'][0] == 'c' ? 'checked' : '' ?>>Créer un nouveau compte.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q8'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q8" value="d" <?= $this->input['q8'][0] == 'd' ? 'checked' : '' ?>>Eteindre son ordinateur.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q9'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q9" value="a" <?= $this->input['q9'][0] == 'a' ? 'checked' : '' ?>>Vous la branchez pour voir ce qu’elle contient.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q9'][0] == 'b' ? 'incorrect' : '' ?>">
            <input type="radio" name="q9" value="b" <?= $this->input['q9'][0] == 'b' ? 'checked' : '' ?>>Vous la gardez.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q9" value="c" <?= $this->input['q9'][0] == 'c' ? 'checked' : '' ?>>Vous la remettez au service informatique.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q9'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q9" value="d" <?= $this->input['q9'][0] == 'd' ? 'checked' : '' ?>>Vous la jetez à la poubelle.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished && $this->input['q10'][0] == 'a' ? 'incorrect' : '' ?>">
            <input type="radio" name="q10" value="a" <?= $this->input['q10'][0] == 'a' ? 'checked' : '' ?>>Pour changer l’apparence du système.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="radio" name="q10" value="b" <?= $this->input['q10'][0] == 'b' ? 'checked' : '' ?>>Pour corriger des failles de sécurité.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q10'][0] == 'c' ? 'incorrect' : '' ?>">
            <input type="radio" name="q10" value="c" <?= $this->input['q10'][0] == 'c' ? 'checked' : '' ?>>Pour ralentir l’ordinateur.<br>
        </label>
        <label class="<?= $this->questionnaireFinished && $this->input['q10'][0] == 'd' ? 'incorrect' : '' ?>">
            <input type="radio" name="q10" value="d" <?= $this->input['q10'][0] == 'd' ? 'checked' : '' ?>>Pour supprimer des fichiers.<br>
        </label>
        ...
        <?php endif; ?>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="checkbox" name="q11[]" value="a" <?= in_array('a', $this->input['q11']) ? 'checked' : '' ?>>J’utilise un stockage de données professionnelles distinct du stockage de données personnelles.<br>
        </label>
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="checkbox" name="q11[]" value="b" <?= in_array('a', $this->input['q11']) ? 'checked' : '' ?>>J’utilise ma connexion professionnelle uniquement pour mes besoins professionnels.<br>
        </label>
        ...
        <label class="<?= $this->questionnaireFinished ? 'correct' : '' ?>">
            <input type="checkbox" name="q11[]" value="d" <?= in_array('a', $this->input['q11']) ? 'checked' : '' ?>>J’effectue les mises à jour de mes systèmes très régulièrement.<br>
        </label>
